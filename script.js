(function() { 
  ...
  const imageFor = { 
    ...
    "Uab pay Top Up": "https://ik.imagekit.io/qfcioh4up/uab.png",
  ...
  const productData = { 
    ...
    "Disney+": { 
        ...
        "Plan Premium": [{ duration: "Sharing 3U (No Limit)", price: "Out of stock" }]
    }, 
    "HBO Max": { 
...
Page မှာ Policy ငြိတာမျိုး လုံးဝမရှိပါဘူး။ Meta Ads ကနေ တရားဝင်လုပ်ပေးတာမလို့ Reach တွေက တကယ့် Customer အစစ်တွေဆီ ရောက်မှာပါ။` + generalDetailsBlock,
    ...
    "Uab pay Top Up": `(KPay-WavePay-AyaPay-CbPay-YomaPay-OKpay-A+wallet-Trustypay-CTZpay) to Uabpay ငွေလဲနိုင်ပါတယ်။လက်ခံမယ့်ဖုန်းနံပါတ် နဲ အကောင့် Name ကို တခါထဲ တွဲပို့ပေးပါ။  09950004440 ဒီဖုန်း တလုံးသာ အသုံးပြုပါသည်။ တခြား ဖုန်း လုံးဝ မသုံးပါ။` + generalDetailsBlock,
  };
  ...
  const deviceSupport = { 
    ...
    /* Uab Pay Top Up Service Support */
    "Uab pay Top Up": ["android", "ios"],
  };
